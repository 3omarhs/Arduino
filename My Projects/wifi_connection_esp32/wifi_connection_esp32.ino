...
#define REMOTEXY_WIFI_SSID "3omar.hs AI_Cam project"
#define REMOTEXY_WIFI_PASSWORD "12345678orhs"
...
uint8_t RemoteXY_CONF[] =
  { 255,1,0,2,0,23,0,11,116,1,
  2,1,20,43,22,11,95,8,31,31,
  61,0,61,0,65,43,26,30,9,9 };
