...
void clear_lcd_after_8_seconds() {
  if ((millis() - myTime >= 8000) && (millis() - myTime <= 9000)) {
    clearLCD();
    j = 0;
    charCounter = 0;
    password = "";
...
void clear_lcd_after_15_seconds() {
  if ((millis() - clearTime >= 15000) && (millis() - clearTime <= 16000)) {
    clearLCD();
    charCounter = 0;
...
void rfid_read() {
  ...
  if (success) {
    ...
    if ((RFval == "2505723392") || (RFval == "83128933") || (RFval == "15363235193") || (RFval == "24211390211") || (RFval == "25017921492")) {
