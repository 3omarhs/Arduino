...
#include <Ultrasonic.h>
Ultrasonic ultrasonic(0, 15);//(D7, D6); //(tigger, echo)  >> echo>D5
int distance;


#include "DHTesp.h"
#define DHTpin 16//14 //D5
DHTesp dht;

int relay_pump = 17;//edited D2 to G;
int buzzer = 22;//D4;
int Sensor_read = 13;//A0;
int Red_led = 2;//D8;

const int sensorPin = 18;//D4;  //D4  soil humidity
int sensorState = 0;
...
uint8_t RemoteXY_CONF[] =   // 181 bytes
  { 255,8,0,0,0,174,0,16,16,1,129,0,6,26,21,4,178,87,97,116,
  101,114,32,76,101,118,101,0,129,0,6,41,21,4,0,83,111,105,108,32,
  72,117,109,105,100,105,116,121,0,129,0,6,59,23,4,35,84,101,109,112,
  101,114,97,116,117,114,101,0,7,53,33,41,20,5,2,26,2,7,53,33,
  26,20,5,2,26,2,7,53,33,59,20,5,2,26,2,129,0,6,73,23,
  4,254,72,117,109,105,100,105,116,121,0,7,53,33,73,20,5,2,26,2,
  129,0,54,26,5,6,17,37,0,129,0,54,59,6,5,17,194,176,67,0,
  129,0,54,73,5,6,17,37,0,129,0,33,46,19,3,36,49,32,110,101,
  101,100,32,119,97,116,101,114,0,129,0,54,40,6,6,17,240,159,140,167,
  0 };
...
void LDR_sensor() {
  int val1 = analogRead(Sensor_read) / 10;
//  RemoteXY.LDR_val = val1;
  Serial.print("LDR: ");
  Serial.println(val1);
  delay(200);
}
