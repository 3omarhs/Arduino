...
/*//////////////////////////////////////////////////
  lcd.setCursor(0, 1);
  String now = (String)rtc.getWeekday();
  now += "_";
  now += String(rtc.getDay());
  now += "/";
  now += String(rtc.getMonth());
  now += "/";
  now += "20";
  now += String(rtc.getYear());
  lcd.print(now);
  *//////////////////////////////////////////////////
...
void loop() { //31°53'54.3"N 35°53'24.5"E   35.890138,31.898427 
  //getDateDs1307() ; //13.4, 52.5167     //30.585164, 36.238414      //31.953949,  35.910635       //31.898417, 35.890132      //35.57, 31.57  //rtc.getYear(), rtc.getMonth(), rtc.getDay()
  calcPrayerTimes(21 , 10 , 30,  35.9, 31.9,  2, -18, -18, fajr, sunRise, zuhr, asr, maghrib, isha); // year , month, day, Longitude, Latitude, Time Zone, Fajr Twilight, Esha Twilight
  
//calcPrayerTimes(int year, int month, int day, double longitude, double latitude, int timeZone, double fajrTwilight, double ishaTwilight, double &fajrTime, double &sunRiseTime, double &zuhrTime, double &asrTime, double &maghribTime, double &ishaTime)
